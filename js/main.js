...
(function () {
  ...
  const i18nData = {
    tr: {
      ...
      'hero.subtitle': 'Yazılım Geliştirici & <strong><a href="https://hypercord.pro" target="_blank" style="color:var(--accent-light); text-decoration:underline;">Hypercord (hypercord.pro)</a></strong> Kurucusu. Özel Discord eklentileri, masaüstü istemci modları, tema sistemleri ve tam donanımlı web uygulamaları geliştiriyorum.',
      ...
      'about.title': 'Hypercord\'un geliştiricisi — Özelleştirilebilir Discord istemci modları ve modern web uygulamaları geliştiriyorum.',
      'about.bio.badge': 'Biyografi',
      'about.bio.title': 'Yazılım Geliştirici & Hypercord Kurucusu',
      'about.bio.p1': 'Ben Henox (<a href="https://henox.me" style="color:var(--accent-light);">henox.me</a>), açık kaynaklı özelleştirilebilir Discord istemci modu olan <strong><a href="https://hypercord.pro" target="_blank" style="color:var(--accent-light);">Hypercord (hypercord.pro)</a></strong>\'un kurucusu ve lider geliştiricisiyim.',
      'about.bio.p2': 'Geliştirme yığınım <strong>HTML5, CSS3, JavaScript, PHP, Laravel, SQL / DB, Python, Node.js, React, Next.js, Vite, ASP.NET Core, Tailwind CSS, Docker</strong> ve <strong>PostgreSQL</strong> teknolojilerini kapsar.',
      ...
      'projects.subtitle': 'Yüksek performanslı özel Discord istemci modları, web uygulamaları ve anlık araçlar.',
      ...
      'hypercord.desc': 'Hypercord, Henox tarafından geliştirilen yüksek performanslı açık kaynaklı bir Discord istemci modudur. Kullanıcıların özel profil rozetleri eklemesine, özel tema ve eklentiler yüklemesine olanak tanır.',
      'hypercord.bullet1': 'Özel profil rozetleri, CSS tema motoru ve eklenti ekosistemi.',
      'hypercord.bullet2': 'Hafif mimari, anında sıcak yeniden yükleme (hot-reload) ve düşük RAM kullanımı.',
      ...
      'lanyard.desc': 'Lanyard WebSocket API ile güçlendirilmiş canlı Discord durumu & Spotify aktivite kartı. Anlık durum senkronizasyonu ve dinamik müzik ilerleme çubuğu içerir.',
      ...
      'skills.subtitle': 'Geliştirmede kullandığım temel programlama dilleri, framework\'ler, veritabanları ve devops araçları.',
      ...
      'contact.title': 'İletişime Geçelim &amp;<br><span class="accent-text">Harika Şeyler Üretelim.</span>',
      'contact.subtitle': 'Hypercord (hypercord.pro) hakkında geri bildirim vermek, özel eklentiler üzerinde çalışmak veya geliştirme talepleri için ulaşabilirsin!',
      'contact.email.label': 'E-posta',
      'contact.project.label': 'Hypercord Projesi',
      'contact.github.label': 'GitHub',
      'footer.builtby': 'Tasarım & Geliştirme: <a href="https://henox.me">Henox</a> (henox.me) · 2026'
    },
    en: {
      'nav.home': 'Home',
      'nav.about': 'About',
      ...
      'hero.subtitle': 'Software Developer & Founder of <strong><a href="https://hypercord.pro" target="_blank" style="color:var(--accent-light); text-decoration:underline;">Hypercord (hypercord.pro)</a></strong>. Crafting open-source client mods, custom badges, theme engines, and full-stack web applications.',
      'hero.availability': 'Building Hypercord · henox.me',
      'hero.cta.work': 'View Projects →',
      'hero.cta.hypercord': 'Visit Hypercord.pro',
      'hero.cta.contact': 'Get in Touch →',
      'about.label': 'About Me',
      'about.title': 'Creator of Hypercord — developing custom Discord client modifications and modern web applications.',
      'about.bio.badge': 'Biography',
      'about.bio.title': 'Software Developer & Founder of Hypercord',
      'about.bio.p1': 'I am Henox (<a href="https://henox.me" style="color:var(--accent-light);">henox.me</a>), creator and lead developer of <strong><a href="https://hypercord.pro" target="_blank" style="color:var(--accent-light);">Hypercord (hypercord.pro)</a></strong> — an open-source custom Discord client modification engineered for custom profile badges, custom plugins, and sleek theme engines.',
      'about.bio.p2': 'My stack spans <strong>HTML5, CSS3, JavaScript, PHP, Laravel, SQL / DB, Python, Node.js, React, Next.js, Vite, ASP.NET Core, Tailwind CSS, Docker,</strong> and <strong>PostgreSQL</strong>.',
      'lanyard.badge': 'Discord Status',
      'spotify.label': 'Listening to Spotify',
      'projects.label': 'Projects & Creations',
      'projects.title': 'Things I\'ve <span class="accent-text">built.</span>',
      'projects.subtitle': 'High-performance custom Discord client modifications, full-stack applications, and real-time tools.',
      'filter.all': 'All',
      'filter.flagship': 'Flagship Client Mod',
      'filter.discord': 'Discord Tools',
      'filter.web': 'Web & APIs',
      'hypercord.category': 'Open-Source Discord Client Modification',
      'hypercord.title': 'Hypercord (hypercord.pro)',
      'hypercord.desc': 'Hypercord is a feature-rich open-source Discord client modification built by Henox. It allows users to customize their profiles with custom badges, load custom plugins & themes, and optimize client performance.',
      'hypercord.bullet1': 'Custom profile badges, CSS theme engine, and plugin ecosystem.',
      'hypercord.bullet2': 'Lightweight architecture with instant hot-reloading & low RAM footprint.',
      'hypercord.btn.website': 'Official Website (hypercord.pro) ↗',
      'hypercord.btn.github': 'GitHub Profile (Henox77) ↗',
      'lanyard.category': 'Full-Stack Integration',
      'lanyard.title': 'Lanyard Real-Time RPC & Spotify Card',
      'lanyard.desc': 'A live Discord presence & Spotify activity player card powered by Lanyard WebSocket API. Features instant status synchronization and dynamic music progress bar.',
      'lanyard.btn.view': 'View Widget Above ↑',
      'skills.label': 'Skills & Technologies',
      'skills.title': 'Tech <span class="accent-text">Stack.</span>',
      'skills.subtitle': 'Core programming languages, frameworks, databases, and devops tools used in my development.',
      'skills.cat.frontend': 'Frontend Development',
      'skills.cat.backend': 'Backend & APIs',
      'skills.cat.database': 'Databases & DevOps',
      'contact.label': 'Get in Touch',
      'contact.title': 'Let\'s connect &amp;<br><span class="accent-text">build something awesome.</span>',
      'contact.subtitle': 'Have feedback for Hypercord (hypercord.pro), want to collaborate on custom plugins, or need custom development? Reach out!',
      'contact.email.label': 'Email',
      'contact.project.label': 'Hypercord Project',
      'contact.github.label': 'GitHub',
      'footer.builtby': 'Designed & Built by <a href="https://henox.me">Henox</a> (henox.me) · 2026'
    }
  };
